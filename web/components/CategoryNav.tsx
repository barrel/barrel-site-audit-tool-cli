...
/** Cross-page tabs (Overview / Site Vitals / Theme Check / UX / SEO/GEO / ADA / All) — distinct
 * from ReportNav, which jumps to anchors within whichever of those pages is currently open. */
export function CategoryNav({ slug, id }: { slug: string; id: string }) {
